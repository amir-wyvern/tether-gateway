...
def user_register_by_phonenumber(user: UserRegisterByPhoneNumber, db: Session=Depends(get_db)):
...
def user_register_by_email(user: UserRegisterByEmail, db: Session=Depends(get_db)):
